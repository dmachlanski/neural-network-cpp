...
public:
	...
	void Train(double learningRate, double momentum, int batchSize, int epochs, double altStop, int printOn);
...
private:
	...
	MatrixXd X_train, Y_train, X_valid, Y_valid, X_test, Y_test, W1, W2, gradW1, gradW2, A1, bestW1, bestW2, dW1, dW2;
	VectorXd b1, b2, gradB1, gradB2, muX, sigmaX, muY, sigmaY, J, Valid, bestB1, bestB2, db1, db2;
};